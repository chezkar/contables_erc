...
use Cuentas\PolizasBundle\Entity\Cliente;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clientes = $em->getRepository('PolizasBundle:Cliente')->findAll();
    ...
    {
        $cliente = new Cliente();
        $form = $this->createForm('Cuentas\PolizasBundle\Form\ClienteType', $cliente);
    ...
    {
        $deleteForm = $this->createDeleteForm($cliente);
        $editForm = $this->createForm('Cuentas\PolizasBundle\Form\ClienteType', $cliente);
